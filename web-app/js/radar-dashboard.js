...
RADAR.Dashboard = {
    init: function (sraUrl, sraUsername, sraPassword, useSSO, refreshInterval) {
        this.username = sraUsername;
        this.password = sraPassword;
        this.appFilter = "?name=";
    ...
    render: function (data) {
        ...
        this.appRequest.then(function(data) {
            ...
            $.each(data, function(i, app) {
                ...
                $.ajax({
                    contentType: "application/json",
                    dataType: "json",
                    //headers: { ALFSSOAuthNToken: RADAR.Util.getSsoToken() },
                    headers: {
                        "DirectSsoInteraction": false,
                        "Authorization": RADAR.Util.makeBasicAuth("admin", "admin")
                    },
        ...
        /*var todos = this.getFilteredTodos();
         ...
         this.renderFooter();
         this.$newTodo.focus();
         RADAR.Util.store('todos-jquery', this.todos);*/
    },
    renderFooter: function () {
        ...
        var template = this.footerTemplate({
            ...
            activeTodoWord: RADAR.Util.pluralize(activeTodoCount, 'item'),
